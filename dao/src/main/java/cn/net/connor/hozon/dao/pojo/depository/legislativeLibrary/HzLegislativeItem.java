...
public class HzLegislativeItem {
    /**
     * 主键
     */
    private String puid;
     ...
     * 是否需要强检报告
     */
    private Integer isHaveTest;
    /**
     * 是否需要3C证书
     */
    private Integer isHaveCcc;
    ...
    public Integer getIsHaveTest() {
        return isHaveTest;
    }

    public void setIsHaveTest(Integer isHaveTest) {
        this.isHaveTest = isHaveTest;
    }

    public Integer getIsHaveCcc() {
        return isHaveCcc;
    }

    public void setIsHaveCcc(Integer isHaveCcc) {
