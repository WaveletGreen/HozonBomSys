...
public class HzFeatureValue {
    ...
    public void setFeatureValueCode(String pCfg0ObjectId) {
        this.featureValueCode = pCfg0ObjectId == null ? null : pCfg0ObjectId.trim();
    }
