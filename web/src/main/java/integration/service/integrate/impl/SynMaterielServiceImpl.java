...
import static cn.net.connor.hozon.common.util.StringUtils.checkStringIsEmpty;
...
//        );
        ...
        if (resultPool != null)
            for (ZPPTCO001 zpptco001 : resultPool) {
                ...
                IntegrateMsgResponseDTO msgDTO = new IntegrateMsgResponseDTO();
...
//        if (puids != null && puids.size() > 0) {//?
        if (ListUtils.isNotEmpty(toUpdate)) {
