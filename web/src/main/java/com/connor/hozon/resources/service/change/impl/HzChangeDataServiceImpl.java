...
import cn.net.connor.hozon.services.common.enumtype.ChangeTypeEnum;
...
import com.connor.hozon.resources.service.change.HzChangeDataService;
...
//                updateQuery.setPuids(puids);
                ...
                if(ListUtils.isNotEmpty(afterRecords)){
...
//                addQuery.setPuids(puids);
                ...
                if(ListUtils.isNotEmpty(addRecords)){
...
//                deleteQuery.setPuids(puids);
    ...
    public WriteResultRespDTO deleteEBOMChangeDataDetail(BomBackReqDTO reqDTO) {
        ...
        try {
            if(ListUtils.isNotEmpty(recordList) && ListUtils.isNotEmpty(records)){
