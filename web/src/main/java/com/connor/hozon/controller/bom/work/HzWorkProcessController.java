...
package com.connor.hozon.controller.bom.work;
...
import com.connor.hozon.service.bom.work.HzWorkProcessService;
...
//        list.forEach(ProcessRequestDTO -> {
//            Map<String, Object> _res = new HashMap<>();
//            _res.put("No", ProcessRequestDTO.getNo());
//            _res.put("materielId", ProcessRequestDTO.getMaterielId());
//            _res.put("pMaterielCode", ProcessRequestDTO.getpMaterielCode());
//            _res.put("pMaterielDesc", ProcessRequestDTO.getpMaterielDesc());
//            _res.put("factoryCode", ProcessRequestDTO.getFactoryCode());
//            _res.put("purpose", ProcessRequestDTO.getPurpose());
//            _res.put("state", ProcessRequestDTO.getState());
//            _res.put("pProcedureCode", ProcessRequestDTO.getpProcedureCode());
//            _res.put("pWorkCode", ProcessRequestDTO.getpWorkCode());
//            _res.put("pWorkDesc", ProcessRequestDTO.getpWorkDesc());
//            _res.put("controlCode", ProcessRequestDTO.getControlCode());
//            _res.put("pProcedureDesc", ProcessRequestDTO.getpProcedureDesc());
//            _res.put("pCount", ProcessRequestDTO.getpCount());
//            _res.put("pDirectLabor", ProcessRequestDTO.getpDirectLabor());
//            _res.put("pIndirectLabor", ProcessRequestDTO.getpIndirectLabor());
//            _res.put("pMachineLabor", ProcessRequestDTO.getpMachineLabor());
//            _res.put("pBurn", ProcessRequestDTO.getpBurn());
//            _res.put("pMachineMaterialLabor", ProcessRequestDTO.getpMachineMaterialLabor());
//            _res.put("pOtherCost", ProcessRequestDTO.getpOtherCost());
//
//            _list.add(_res);
//        });
