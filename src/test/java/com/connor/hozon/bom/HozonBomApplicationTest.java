...
import com.connor.hozon.bom.resources.dto.request.InsertHzMbomMaintainRecordReqDTO;
...
public class HozonBomApplicationTest {
	...
	public void hzPbomLineMaintainTest(){
		List<InsertHzMbomMaintainRecordReqDTO> list = new ArrayList<>();
		for(int i = 0;i<3;i++){
			InsertHzMbomMaintainRecordReqDTO recordReqDTO = new InsertHzMbomMaintainRecordReqDTO();
