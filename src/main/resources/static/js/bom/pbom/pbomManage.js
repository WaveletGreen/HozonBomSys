...
function queryLou(row) {
    ...
    $.ajax({
        ...
        success: function (result) {
            var data = result.data
            var pCfg0name = (data.pCfg0name == undefined ? "" : data.pCfg0name);
            var cfg0Desc = (data.cfg0Desc == undefined ? "" : data.cfg0Desc);
            var pCfg0familyname = (data.pCfg0familyname == undefined ? "" : data.pCfg0familyname);
            var cfg0FamilyDesc = (data.cfg0FamilyDesc == undefined ? "" : data.cfg0FamilyDesc);
            var _table = '<div style="max-height: 400px;overflow:scroll;"><table class="table table-striped tableNormalStyle" >';
