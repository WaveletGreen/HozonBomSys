...
(function(e, t) {
    ...
    function() {
        ...
        for (var V = Math.min,
                 _ = Math.floor,
                 X = Math.max,
                 Q = ['native code', '[object MutationObserverConstructor]'], J = function(e) {
                        ...
                        fn: function(e, t) {
                            ...
                            return p.forEach(function(s, d) {
                                ...
                                var a = e.offsets.popper,
                                    ...
                                    w = !!t.flipVariations && (y && 'start' === r && c || y && 'end' === r && h || !y && 'start' === r && g || !y && 'end' === r && u); (m || b || w) && (e.flipped = !0, (m || b) && (i = p[d + 1]), w && (r = j(r)), e.placement = i + (r ? '-' + r: ''), e.offsets.popper = de({},
                    ...
                    computeStyle: {
                        ...
                        fn: function(e, t) {
                            ...
                            var s, d, a = void 0 === p ? t.gpuAcceleration: p,
                                ...
                                b = B('transform');
                            if (d = 'bottom' == h ? -f.height + c.bottom: c.top, s = 'right' == u ? -f.width + c.right: c.left, a && b) m[b] = 'translate3d(' + s + 'px, ' + d + 'px, 0)',
                                m[h] = 0,
                                m[u] = 0,
