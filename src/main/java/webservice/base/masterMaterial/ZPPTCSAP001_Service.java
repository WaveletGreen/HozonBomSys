...
public class ZPPTCSAP001_Service extends Service  {
    ...
    private final static Logger logger = Logger.getLogger(webservice.base.masterMaterial.ZPPTCSAP001_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = webservice.base.masterMaterial.ZPPTCSAP001_Service.class.getResource("/");
