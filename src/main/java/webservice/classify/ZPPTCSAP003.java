...
public interface ZPPTCSAP003 {
	...
	@RequestWrapper(localName = "ZPP_TC_SAP_003", targetNamespace = "urn:sap-com:document:sap:rfc:functions", className = "webservice.classify.ZPPTCSAP003_Type")
	@ResponseWrapper(localName = "ZPP_TC_SAP_003Response", targetNamespace = "urn:sap-com:document:sap:rfc:functions", className = "webservice.classify.ZPPTCSAP003Response")
