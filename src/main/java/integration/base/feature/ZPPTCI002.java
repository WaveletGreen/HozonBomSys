...
/**
 * <p>
 * Java class for ZPP_TCI002 complex type.
 * 
 * <p>
 ...
 *         &lt;element name="P_ATBEZ" type="{urn:sap-com:document:sap:rfc:functions}char30"/>
 *         &lt;element name="P_ATWRT" type="{urn:sap-com:document:sap:rfc:functions}char70"/>
 *         &lt;element name="P_ATWTB" type="{urn:sap-com:document:sap:rfc:functions}char70"/>
...
@XmlType(name = "ZPP_TCI002", propOrder = { "ppackno", "pitem", "pactionid", "patnam", "patbez", "patwrt", "patwtb",
...
public class ZPPTCI002 {
	...
	@XmlElement(name = "P_ATBEZ", required = true)
	protected String patbez;
	@XmlElement(name = "P_ATWRT", required = true)
	protected String patwrt;
	@XmlElement(name = "P_ATWTB", required = true)
	protected String patwtb;
	...
	/**
	 * Gets the value of the patbez property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	public String getPATBEZ() {
		return patbez;
	}

	/**
	 * Sets the value of the patbez property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
	 */
	public void setPATBEZ(String value) {
		this.patbez = value;
	}
	...
	/**
	 * Gets the value of the patwtb property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	public String getPATWTB() {
		return patwtb;
	}

	/**
	 * Sets the value of the patwtb property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
	 */
	public void setPATWTB(String value) {
		this.patwtb = value;
	}
